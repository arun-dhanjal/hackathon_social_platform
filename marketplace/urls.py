...
urlpatterns = [
    ...
    path(
        'selling/create/',
        views.create_selling_post,
        name='create_selling_post'
    ),
    path(
        'selling/<int:pk>/',
        views.selling_post_detail,
        name='selling_post_detail'
    ),
    path(
        'selling/<int:pk>/commit-buy/',
        views.commit_to_buy,
        name='commit_to_buy'
    ),
    ...
    path(
        'buying/create/',
        views.create_buying_post,
        name='create_buying_post'
    ),
    ...
    path(
        'listing/<int:listing_pk>/accept-bid/<int:bid_pk>/',
        views.accept_bid,
        name='accept_bid'
    ),
