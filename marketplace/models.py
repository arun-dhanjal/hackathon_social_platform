...
class Notification(models.Model):
    ...
    related_selling_post = models.ForeignKey(
        'SellingPost', on_delete=models.CASCADE, null=True, blank=True
    )
    ...
    def __str__(self):
        return (
            f"{self.notification_type} notification from "
            f"{self.sender.username} to {self.recipient.username}"
        )
...
class SellingPost(models.Model):
    ...
    seller = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='selling_posts'
    )
...
class MarketComment(models.Model):
    post = models.ForeignKey(
        SellingPost, on_delete=models.CASCADE, related_name='comments'
    )
...
class Listing(models.Model):
    ...
    accepted_bid = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='accepted_for_listing'
    )
    created_at = models.DateTimeField(auto_now_add=True)
    ...
    def get_winner(self):
        ...
        (either accepted bid or highest if auction ended)
        """
...
class Bid(models.Model):
    ...
    bidder = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='listing_bids'
    )
    ...
    def __str__(self):
        return (
            f'Bid of £{self.amount} by {self.bidder.username} '
            f'on {self.listing.title}'
        )
